  ...
  <div class="row">
    ...
    <div class="col-md-8">
      <div class="container-fluid">
        ...
        <div class="row">
              <div class="col-md-4 col-xs-12 text-primary"><h2>Darba pieredze</h2></div>
              <div class="col-md-8 col-xs-12"><p></p></div>
        </div>
        <div class="row">
              <div class="col-md-4 col-xs-12"><h5 class="text-primary"><b>01/06/2015-05/09/2015</b></h5></div>
              <div class="col-md-8 col-xs-12">
                <p class="text-info"><b>Bruģētājs</b></p>
                <p><b>"Delta AP"</b>, Talsi (Latvija)</p>
                <p>- Bruģakmeņa likšana, laukumu veidošana, bruģa apkope</p>
              </div>
        </div>
